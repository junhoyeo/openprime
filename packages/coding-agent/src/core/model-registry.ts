...
export class ModelRegistry {
	...
	/**
	 * Bundled models this fork ships that the remote provider catalog does not
	 * list (e.g. OpenCode Zen stealth models). They ride alongside the remote
	 * catalog instead of being replaced by it; a remote entry with the same
	 * provider/id wins.
	 */
	...
	private loadBuiltInModels(
		...
		const bundledModels = remote
			? [...remote, ...this.bundledPrimeInferenceModels(), ...this.bundledForkExtraModels(remote)]
			: this.bundledCatalogModels;
