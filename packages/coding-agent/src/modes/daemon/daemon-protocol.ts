...
export type DaemonServerCapability =
	...
	// Attach results report wasAttached (whether the socket already had an
	// attachment entry). Clients must negotiate this before using the field to
	// decide whether cleanup may safely detach a shared client.
	| "attach_ownership"
